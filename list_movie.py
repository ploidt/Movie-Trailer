...
rouge_one = movie.Movie("Rogue One",
                        ...
                        "d4/Rogue_One%2C_A_Star_Wars_Story_poster.png/"
...
la_la_land = movie.Movie("La La Land",
                         ...
                         "La_La_Land_%28film%29.png",
                         "https://www.youtube.com/watch?v=0pdqf4P9MB8")

# Secret Life of Pets Movie
secret_life_of_pets = movie.Movie("The Secret Life Of Pets",
                                  "https://upload.wikimedia.org/wikipedia/en/"
                                  "thumb/6/64/The_Secret_Life_of_Pets_poster.jpg/"
                                  "220px-The_Secret_Life_of_Pets_poster.jpg",
...
conjuring_2 = movie.Movie("The Conjuring 2",
                          ...
                          "b/b9/Conjuring_2.jpg/220px-Conjuring_2.jpg",
                          "https://www.youtube.com/watch?v=KyA9AtUOqRM")

# Your name Movie
your_name = movie.Movie("Your name",
                        "https://upload.wikimedia.org/wikipedia/en/0/0b/"
                        "Your_Name_poster.png",
